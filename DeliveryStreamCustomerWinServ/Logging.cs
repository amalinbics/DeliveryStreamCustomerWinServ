...
namespace DeliveryStreamCustomerWinServ
{
    ...
    public class Logging
    {
        ...
        // 12-06-2013 FSWW Ramesh M Added WriteToErrorLogFile Method for writing Log For CR#?..
        /// <summary>
        /// Function to write the message in log file
        /// </summary>
        /// <param name="message"></param>
        public static void WriteToErrorLogFile(String message)
        {
